...
public class userTable extends javax.swing.JFrame {
    ...
    private createMembership parent;
     ...
     public userTable(createMembership parent) {
    initComponents();
      this.parent = parent;
        displayData();
    }
    ...
    private void initComponents() {
        ...
        userTable.setFont(new java.awt.Font("Agency FB", 0, 15)); // NOI18N
        ...
        Container.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 130, 780, 460));
...
if (rowIndex < 0) {
    ...
    String selectedUserId = userTable.getValueAt(rowIndex, 0).toString();
    parent.setSelectedUserId(selectedUserId);
