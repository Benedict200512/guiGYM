...
public class CustomerDashboard extends javax.swing.JFrame {
    ...
    public void displayData(){
        try{
            ...
            ResultSet rs = dbc.getData("SELECT * FROM tbl_customers");
    ...
    private void initComponents() {
        ...
        customersTable.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        customersTable.setFont(new java.awt.Font("Agency FB", 0, 15)); // NOI18N
...
try {
    ...
    String query = "SELECT * FROM tbl_customers WHERE customer_id = ?";
...
if (confirm == JOptionPane.YES_OPTION) {
    try {
        ...
        String deleteQuery = "DELETE FROM tbl_customers WHERE customer_id = ?";
        PreparedStatement ps = dbc.connect.prepareStatement(deleteQuery);
        ps.setInt(1, customerId);
        int rowsAffected = ps.executeUpdate();

        if (rowsAffected > 0) {
            JOptionPane.showMessageDialog(this, "Customer ID " + customerId + " Deleted successfully.");
            ((DefaultTableModel) customersTable.getModel()).removeRow(selectedRow); 
        } else {
    ...
    private void editMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_editMouseClicked
        ...
        try{            
            dbConnector dbc = new dbConnector();
            TableModel tbl = customersTable.getModel();
            ResultSet rs = dbc.getData("SELECT * FROM tbl_customers WHERE customer_id = '"+tbl.getValueAt(rowIndex, 0)+"'");
            if(rs.next()){
            CustomerForm cf = new CustomerForm();
            cf.cid.setText(""+rs.getInt("customer_id"));
            cf.uid.setText(""+rs.getInt("user_id"));
            cf.mid.setText(""+rs.getString("membership_id"));
            cf.coachid.setText(""+rs.getString("assigned_coach_id"));
            cf.dj.setText(""+rs.getString("date_joined"));
            cf.gn.setSelectedItem(""+rs.getString("gender"));
            cf.address.setText(""+rs.getString("address"));  
            cf.stat.setSelectedItem(""+rs.getString("status"));
            cf.image.setIcon(cf.ResizeImage(rs.getString("user_image"), null, cf.image));
            cf.add.setEnabled(false);
            cf.update.setEnabled(true);
            cf.setVisible(true);
