...
public class membershipForm extends javax.swing.JFrame {
    ...
    public void displayData(){
        try{
            ...
            ResultSet rs = dbc.getData("SELECT * FROM tbl_membership");
    ...
    private void searchMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_searchMouseClicked
        String membershipId = searchField.getText().trim();

        if (membershipId.isEmpty() || !membershipId.matches("\\d+")) {
            JOptionPane.showMessageDialog(this, "Please enter a valid numeric Membership ID.");
            return;
        }
        ...
        try {
            ...
            String query = "SELECT * FROM tbl_membership WHERE membership_id = ?";
            PreparedStatement ps = dbc.connect.prepareStatement(query);
            ps.setInt(1, Integer.parseInt(membershipId));
            ...
            while (rs.next()) {
                Object[] row = {
                    ...
                    rs.getString("m_start_date"),
                    rs.getString("m_end_date"),
                    rs.getString("m_cost"),
                };
                model.addRow(row);
            }
            ...
            if (model.getRowCount() == 0) {
                JOptionPane.showMessageDialog(this, "No membership found with ID: " + membershipId);
            }
    ...
    private void editMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_editMouseClicked
        ...
        if (rowIndex < 0) {
         JOptionPane.showMessageDialog(null, "Please select a membership!");
        } else {
        try {
        dbConnector dbc = new dbConnector();
        ...
        ResultSet rs = dbc.getData(
            "SELECT * FROM tbl_membership WHERE membership_id = '"
        ...
        if (rs.next()) {
            ...
            createMembership cmf = new createMembership();

           
            cmf.mid.setText("" + rs.getInt("membership_id"));
            cmf.uid.setText("" + rs.getInt("user_id"));
            cmf.ms.setSelectedItem(rs.getString("m_status"));
            cmf.sd.setText(rs.getDate("m_start_date").toString());
            cmf.ed.setText(rs.getDate("m_end_date").toString());
            cmf.mc.setText(rs.getBigDecimal("m_cost").toPlainString());       
            cmf.add.setEnabled(false);
            cmf.update.setEnabled(true);
